...
public class TesteController {
	...
	public ModelAndView retornaPaginaEdicao(@PathVariable Long id) {
		...
		if (op.isPresent()) {
			...
			ModelAndView mv = new ModelAndView("editar_discente");
	...
	public ModelAndView atualizarDiscente(@PathVariable Long id, @Valid Discente discente, BindingResult bd) {
	...
	@GetMapping("/discente/{id}/remover")
